...
{name: "main-navigation-text-hover", selector: ".gdlr-main-menu > li:hover > a, .gdlr-main-menu > li.current-menu-item > a, .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; opacity: 1; filter: alpha(opacity=100); } .gdlr-navigation-gimmick{ background-color: #gdlr#; }"},
{name: "search-box-background-color", selector: ".gdlr-menu-search{ background: #gdlr#; background: rgba(#gdlra#, 0.8); }"},
{name: "search-box-color", selector: "#gdlr-menu-search input[type=\"text\"]{ color: #gdlr#; }"},
{name: "float-menu-background", selector: ".gdlr-fixed-header .gdlr-header-inner{ background-color: #gdlr#; }"},
...
{name: "body-link-color", selector: "a{ color: #gdlr#; }.single-session .gdlr-session-info .session-info.session-document a, .single-session .gdlr-session-info .session-info.session-document i{ color: #gdlr#; }"},
...
{name: "twitter-icon-color", selector: "ul.gdlr-twitter-widget li:before{ color: #gdlr#; }"},
{name: "twitter-time-color", selector: "ul.gdlr-twitter-widget li .gdlr-twitter-time{ color: #gdlr#; }"},
...
{name: "button-border-color", selector: ".gdlr-button.with-border{ border-color: #gdlr#; }"},
...
{name: "blog-date-color", selector: ".gdlr-blog-full .post-header-bottom-gimmick{ border-color: #gdlr#; }.gdlr-blog-date-wrapper{ color: #gdlr#; }"},
...
{name: "portfolio-filter-button-active-background", selector: ".portfolio-item-filter a:hover, .portfolio-item-filter a.active{ background-color: #gdlr#; } "},
...
{name: "speaker-item-title", selector: ".gdlr-speaker-item .gdlr-speaker-item-title a{ color: #gdlr#; }"},
{name: "speaker-item-position", selector: ".gdlr-speaker-item .gdlr-speaker-item-position{ color: #gdlr#; }"},
{name: "speaker-info-text", selector: ".single-speaker .gdlr-speaker-info-inner, .single-speaker .gdlr-speaker-info-inner a, .single-speaker .gdlr-speaker-info-inner .gdlr-speaker-name{ color: #gdlr#; }"},
{name: "speaker-info-background", selector: ".single-speaker .gdlr-speaker-info-inner { background-color: #gdlr#; }"},
{name: "speaker-info-bottom-border", selector: ".single-speaker .gdlr-speaker-info-inner { border-bottom-color: #gdlr#; }"},
{name: "speaker-session-background", selector: ".single-speaker .gdlr-speaker-session-item{ background-color: #gdlr#; }"},
{name: "speaker-session-bottom-border", selector: ".single-speaker .gdlr-speaker-session-item{ border-bottom-color: #gdlr#; }"},
{name: "speaker-session-title-text", selector: ".single-speaker .speaker-session-item-title a{ color: #gdlr#; }"},
{name: "speaker-session-title-background", selector: ".single-speaker .speaker-session-item-title{ background-color: #gdlr#; }"},
{name: "ticket-head-background", selector: ".gdlr-ticket-item .gdlr-ticket-head{ background-color: #gdlr#; }"},
{name: "ticket-head-title", selector: ".gdlr-ticket-item .gdlr-ticket-head-title{ color: #gdlr#; }"},
{name: "ticket-head-price", selector: ".gdlr-ticket-item .gdlr-ticket-head-price{ color: #gdlr#; }"},
{name: "ticket-content-background", selector: ".gdlr-ticket-item .gdlr-ticket-content{ background-color: #gdlr#; }"},
{name: "ticket-content-text", selector: ".gdlr-ticket-item .gdlr-ticket-content{ color: #gdlr#; }"},
{name: "ticket-button-background", selector: ".gdlr-ticket-item .gdlr-ticket-button { background-color: #gdlr#; }"},
{name: "ticket-button-text", selector: ".gdlr-ticket-item .gdlr-ticket-button { color: #gdlr#; }"},
{name: "ticket-ribbon-background", selector: ".gdlr-ticket-item .gdlr-ticket-head-featured{ background-color: #gdlr#; }"},
{name: "ticket-ribbon-text", selector: ".gdlr-ticket-item .gdlr-ticket-head-featured{ color: #gdlr#; }"},
{name: "lightbox-form-title", selector: ".gdlr-paypal-form-head span{ color: #gdlr#; }"},
{name: "lightbox-paypal-button-background", selector: ".gdlr-paypal-form-wrapper input[type=\"button\"].gdlr-button-paypal{ background-color: #gdlr#; }"},
{name: "lightbox-paypal-button-text", selector: ".gdlr-paypal-form-wrapper input[type=\"button\"].gdlr-button-paypal{ border-bottom-color: #gdlr#; }"},
{name: "session-info-text", selector: ".single-session .gdlr-session-info .session-info, .single-session .gdlr-session-info .session-info a{ color: #gdlr#; }"},
{name: "session-info-icon", selector: ".single-session .gdlr-session-info .session-info i{ color: #gdlr#; }"},
{name: "session-item-head-background", selector: ".gdlr-session-item .gdlr-session-item-head{ background-color: #gdlr#; }"},
{name: "session-item-head-active-background", selector: ".gdlr-session-item .gdlr-session-item-head-info.gdlr-active{ background-color: #gdlr#; }.gdlr-session-item .gdlr-session-item-head-info { border-color: #gdlr#; }"},
{name: "session-item-head-text", selector: ".gdlr-session-item .gdlr-session-item-head{ color: #gdlr#; }"},
{name: "session-item-content-background", selector: ".gdlr-session-item-content-wrapper{ background-color: #gdlr#; }"},
{name: "session-item-title", selector: ".gdlr-session-item .gdlr-session-item-title a{ color: #gdlr#; }"},
{name: "session-item-divider", selector: ".gdlr-session-item .gdlr-session-item-divider{ border-bottom-color: #gdlr#; }"},
{name: "session-break-title", selector: ".gdlr-session-item .gdlr-session-break-title{ color: #gdlr#; }"},
{name: "session-break-time", selector: ".gdlr-session-item .session-break-info{ color: #gdlr#; }"},
{name: "accommodation-background", selector: ".gdlr-accommodation-item{ background-color: #gdlr#; }"},
{name: "accommodation-rating-color", selector: ".gdlr-accommodation-item .accommodation-rating{ background-color: #gdlr#; }"},
