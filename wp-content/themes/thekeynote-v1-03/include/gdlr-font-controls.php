	...
	*/
	...
	$gdlr_font_family = array( 									
		...
		'options' => array(
			...
			'info-font-family' => array(
				'title' => __('Info Font', 'gdlr_translate'),
				'type' => 'font-combobox',
				'default' => 'Arial, Helvetica, sans-serif',
				'data-type' => 'font',
				'selector' => '.gdlr-info-font, ul.gdlr-twitter-widget .gdlr-twitter-time, .gdlr-page-caption{ font-family: #gdlr#; }'
			),			
