...
if (!class_exists('Popup_Login_Custom_Window'))
{
    class Popup_Login_Custom_Window
    {
        ...
        public function register_popup_login_script() {
            ...
            wp_register_script('popup-login', plugin_dir_url(__FILE__).'assets/js/popup-login.js', array(), '1.0.4', true);
            wp_register_style('popup-login', plugin_dir_url(__FILE__).'assets/css/popup-login.css', array(), '1.0.4');
