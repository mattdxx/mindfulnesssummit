...
class WC_Memberships_Membership_Note_Email extends WC_Email {
	...
	function __construct() {
		...
		$this->title          = __( 'Membership note', WC_Memberships::TEXT_DOMAIN );
		$this->description    = __( 'Membership note emails are sent when you add a membership note and notify member.', WC_Memberships::TEXT_DOMAIN );

		$this->template_html  = 'emails/membership-note.php';
		$this->template_plain = 'emails/plain/membership-note.php';

		$this->subject        = __( 'Note added to your {site_title} membership', WC_Memberships::TEXT_DOMAIN);
		$this->heading        = __( 'A note has been added about your membership', WC_Memberships::TEXT_DOMAIN);
